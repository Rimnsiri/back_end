...
Route::get('/cvs/search', [DevController::class, 'search']);
...
Route::post('/cvs', [DevController::class, 'cvdev']);
Route::get('/skills', [SkillController::class ,'getSkills']);
Route::post('/cvs', [DevController::class, 'cvdev']);
Route::get('/cvs/{devId}', [DevController:: class , 'getCvsByDeveloper']);
Route::get('/cvs/details/{cv}', [DevController::class,'showcv']);
Route::delete('/cvs/{cv}', [DevController::class ,'destroycv']);
Route::put('/cvs/{cv}', [DevController::class , 'updatecv']);
