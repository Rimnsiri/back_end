        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('devs.index')" :active="request()->routeIs('devs.index')">
                        devs
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('enregistest.index')" :active="request()->routeIs('enregistest.index')">
                        Enregistrements des Tests
                    </x-nav-link>
                    <x-nav-link :href="route('reponse-tests.index')" :active="request()->routeIs('reponse-tests.index')">
                       Réponse des Tests
                    </x-nav-link> -->
            ...
            <div class="flex items-center -me-2 sm:hidden">
                <button @click="open = ! open"
                        class="inline-flex items-center justify-center p-2 text-gray-400 transition duration-150 ease-in-out rounded-md hover:text-gray-500 focus:outline-none focus:bg-gray-100 focus:text-gray-500">
