...
@section('content')
    <section class="mt-4 dark:bg-gray-900">
        <div class="p-4 mx-auto max-w-screen-2xl md:p-6 2xl:p-10">
                                ...
                                <li>
                                    <div class="flex items-center">
                                        ...
                                        <a href="{{ route('devs.index') }}"
                                            class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2">Développeurs</a>
                                    </div>
                                </li>
                                <li>
                                    <div class="flex items-center">
                                        ...
                                        <a href="#"
                                            class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2">Modifier
                                            développeur</a>
                                    </div>
                                </li>
                            </ol>
            ...
            <div class="card-body d-flex flex-column align-items-center">
                @if ($errors->has('error'))
                <div class="flex items-center mt-9 max-sm:mb-2 alert" id="danger-alert">
                                ...
                                <div class="p-4">
                                    <div class="flex items-start">
                                        ...
                                        <div class="ml-3 w-0 flex-1 pt-0.5">
                                            <p class="text-sm font-medium text-gray-900">Erreur : Mise à jour échouée !</p>
                                            <ul class="mt-2">
                                                <li class="text-red-600">{{ $errors->first('error') }}</li>
                                            </ul>
                                        </div>
            ...
            @endif
                ...
                <form method="POST" action="{{ route('devs.update', $dev->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 gap-9 sm:grid-cols-2">
                        <div class="flex flex-col gap-9">
                            <div
                                ...
                                <div class="grid grid-cols-2 gap-6 mb-3">
                                    ...
                                    <div class="flex items-center space-x-4 form-group">
                                        <img src="{{ asset('storage/photos/' . $dev->photo) }}" class="w-12 h-12 rounded" />
                                        <div class="flex flex-col">
                                            <label for="photo"
                                                class="mb-1 text-sm font-medium text-gray-900 dark:text-white">Changer la
                                                photo</label>
                                            <input type="file"
                                                class="text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-violet-50 file:text-blue-700 hover:file:bg-violet-100"
                                                id="photo" name="photo">
                                        </div>
                                    </div>
                                    ...
                                    <div class="w-full">
                                        ...
                                        <input type="text" id="firstname" value="{{ $dev->firstname }}"
                                            name="firstname"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            required>
                                    </div>
                                    ...
                                    <div class="w-full">
                                        ...
                                        <input type="text" id="title" name="title" value="{{ $dev->title }}"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            required>
                                    </div>
                                    <div class="w-full">
                                        ...
                                        <input type="email" id="email" value="{{ $dev->email }}" name="email"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            required>
                                    </div>
                                    <div class="w-full">
                                        ...
                                        <input type="number" id="phone" value="{{ $dev->phone }}" name="phone"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            required>
                                    </div>
                                    <div class="w-full">
                                        ...
                                        <input type="text" id="address" value="{{ $dev->address }}" name="address"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            required>
                                    </div>
                                    <div class="w-full">
                                        ...
                                        <input type="number" id="tjm" name="tjm" value="{{ $dev->tjm }}"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            required>
                                    </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="niveau" id="niveau"
                                                ...
                                                <option value="débutant"
                                                    {{ $dev->niveau == 'débutant' ? 'selected' : '' }}>
                                                    Débutant
                                                </option>
                                                <option value="sénior" {{ $dev->niveau == 'sénior' ? 'selected' : '' }}>
                                                    sénior
                                                </option>
                                                <option value="expert" {{ $dev->niveau == 'expert' ? 'selected' : '' }}>
                                                    Expert
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="w-full">
                                        ...
                                        <select
                                            ...
                                            <option value="A1" {{ $dev->french_level == 'A1' ? 'selected' : '' }}>A1
                                            </option>
                                            <option value="A2" {{ $dev->french_level == 'A2' ? 'selected' : '' }}>A2
                                            </option>
                                            <option value="B1" {{ $dev->french_level == 'B1' ? 'selected' : '' }}>B1
                                            </option>
                                            <option value="B2" {{ $dev->french_level == 'B2' ? 'selected' : '' }}>B2
                                            </option>
                                            <option value="C1" {{ $dev->french_level == 'C1' ? 'selected' : '' }}>C1
                                            </option>
                                            <option value="C2" {{ $dev->french_level == 'C2' ? 'selected' : '' }}>C2
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="w-full">
                                        ...
                                        <select
                                            ...
                                            <option value="">Sélectionnez un niveau</option>
                                            <option value="A1" {{ $dev->english_level == 'A1' ? 'selected' : '' }}>A1
                                            </option>
                                            <option value="A2" {{ $dev->english_level == 'A2' ? 'selected' : '' }}>A2
                                            </option>
                                            <option value="B1" {{ $dev->english_level == 'B1' ? 'selected' : '' }}>B1
                                            </option>
                                            <option value="B2" {{ $dev->english_level == 'B2' ? 'selected' : '' }}>B2
                                            </option>
                                            <option value="C1" {{ $dev->english_level == 'C1' ? 'selected' : '' }}>C1
                                            </option>
                                            <option value="C2" {{ $dev->english_level == 'C2' ? 'selected' : '' }}>C2
                                            </option>
                                        </select>
                                    </div>

                                    <div class="w-full">
                                        <input type="hidden" name="isontop" value="0">
                                        <input
                                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                            type="checkbox" name="isontop" value="1" id="isontop"
                                            {{ $dev->isontop ? 'checked' : '' }}>
                                        <label for="isontop" class="form-check-label">Is on top?</label>
                                    </div>
                                    <div class="sm:col-span-2">
                                        ...
                                        <textarea
                                            ...
                                            id="description" name="description" rows="3">{{ $dev->description }}</textarea>
                                    </div>
                                </div>
                        ...
                        <div class="flex flex-col gap-9">
                            <div
                                ...
                                <div id="accordion-color" data-accordion="collapse"
                                    ...
                                    @foreach ($dev->experiences as $index => $experience)
                                        <div class="experience-section" id="experience-{{ $experience->id }}">
                                            <h2 id="accordion-color-heading-{{ $experience->id }}">
                                                <button type="button"
                                                    class="flex items-center justify-between w-full gap-3 p-3 font-medium text-gray-500 border border-b-0 border-gray-200 rtl:text-right rounded-t-xl focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-800 dark:border-gray-700 dark:text-gray-400 hover:bg-blue-100 dark:hover:bg-gray-800"
                                                    data-accordion-target="#accordion-color-body-{{ $experience->id }}"
                                                    aria-expanded="false"
                                                    aria-controls="accordion-color-body-{{ $experience->id }}">
                                                    <span class="text-sm"> {{ $experience->title }} -
                                            ...
                                            <div id="accordion-color-body-{{ $experience->id }}" class="hidden"
                                                aria-labelledby="accordion-color-heading-{{ $experience->id }}">
                                                <div
                                                    class="rounded-[5px] border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark p-9">
                                                    <div class="grid grid-cols-2 gap-6 mb-3">
                                                        <input type="hidden"
                                                            name="experiences[{{ $experience->id }}][id]"
                                                            value="{{ $experience->id }}">
                                                        <div class="w-full">
                                                            <label for="experience_title_{{ $experience->id }}"
                                                        ...
                                                        <div class="w-full">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $experience->entreprisename }}"
                                                                placeholder="Company name">
                                                        </div>
                                                        <div class="w-full">
                                                            <label for="startdate_{{ $experience->id }}"
                                                        ...
                                                        <div class="w-full">
                                                            <label for="enddate_{{ $experience->id }}"
                                                            ...
                                                            <input type="date"
                                                                ...
                                                                value="{{ $experience->enddate ? \Carbon\Carbon::parse($experience->enddate)->format('Y-m-d') : '' }}">
                                                            <div class="form-check">
                                                                <input type="checkbox"
                                                                    class="form-check-input ongoing-checkbox"
                                                                    id="experiences[{{ $experience->id }}][is_current]"
                                                                    name="experiences[{{ $experience->id }}][is_current]"
                                                                    {{ $experience->enddate === null ? 'checked' : '' }}>
                                                                <label class="form-check-label"
                                                                    for="experiences[{{ $experience->id }}][is_current]">En
                                                                    Cours</label>
                                                            </div>
                                                        </div>
                                                        <div class="sm:col-span-2">
                                                            <label for="experience_description_{{ $experience->id }}"
                                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Description</label>
                                                            <div id="quill-editor-{{ $experience->id }}"
                                                                class="quill-editor-container"></div>
                                                            <input type="hidden"
                                                                name="experiences[{{ $experience->id }}][description]"
                                                                id="experience_description_{{ $experience->id }}"
                                                                value="{{ $experience->description }}">
                                                        </div>
                                                        <script>
                                                            document.addEventListener('DOMContentLoaded', function() {
                                                                // Initialiser Quill pour chaque éditeur spécifique
                                                                const editorId = 'quill-editor-{{ $experience->id }}';
                                                                const textareaId = 'experience_description_{{ $experience->id }}';
                                                                ...
                                                                // Initialiser Quill avec la valeur actuelle du texte
                                                        ...
                                                        <div class="sm:col-span-2">
                                                            <label for="technologies_{{ $experience->id }}"
                                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Technologies
                                                                Utilisées</label>
                                                            <div id="selectedTechnologies_{{ $experience->id }}"
                                                                class="mb-2">
                                                                @foreach ($experience->skills as $skill)
                                                                    <span class="bg-white badge text-dark me-2"
                                                                        style="border: 1px solid #ccc;">
                                                                        {{ $skill->name }}
                                                                        <span class="ms-1" style="cursor: pointer;"
                                                                            onclick="removeExistingSkill('{{ $experience->id }}', '{{ $skill->id }}')">&times;</span>
                                                                    </span>
                                                                @endforeach
                                                            </div>
                                                            <div class="dropdown mt-9">
                                                                <button
                                                                    class="px-8 py-2.5 bg-blue-500 text-sm text-white hover:bg-blue-600 rounded-sm dropdown-toggle"
                                                                    type="button"
                                                                    id="dropdownMenuButton_{{ $experience->id }}">
                                                                    Sélectionnez les technologies
                                                                </button>

                                                                <div class="dropdown-menu"
                                                                    aria-labelledby="dropdownMenuButton_{{ $experience->id }}"
                                                                    style="max-height: 300px; overflow-y: auto;">
                                                                    <input type="text"
                                                                        id="skillSearch_{{ $experience->id }}"
                                                                        class="form-control"
                                                                        placeholder="Rechercher une technologie"
                                                                        onkeyup="filterSkills('{{ $experience->id }}')">
                                                                    @foreach ($skills->sortBy('name') as $skill)
                                                                        <div class="form-check" style="margin-left: 5px;">
                                                                            <input class="form-check-input"
                                                                                ...
                                                                                onchange="handleSkillSelection('{{ $experience->id }}', '{{ $skill->id }}', '{{ $skill->name }}')">
                                                                            <label class="form-check-label"
                                                                                for="technology_{{ $experience->id }}_{{ $skill->id }}">{{ $skill->name }}</label>
                                                                        </div>
                                                                    @endforeach
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <button type="button" class="btn mt-7 remove-experience"
                                        ...
                                        <div
                                            ...
                                            <div class="grid grid-cols-2 gap-6 mb-3">
                                                ...
                                                <div class="w-full">
                                                    ...
                                                    <input type="text"
                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                        name="new_experience[entreprisename]" placeholder="Company name">
                                                </div>
                                                <div class="w-full">
                                                ...
                                                <div class="sm:col-span-2">
                                                    <label for="experience_description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Description</label>
                                                    
                                                  
                                                    <div id="quill-editor-experience" class="quill-editor-container" style="min-height: 150px;"></div>
                                                    
                                                    
                                                    <input type="hidden" name="new_experience[description]" id="quill-input-experience" required>
                                                </div>
                                                            ...
                                                            @foreach ($skills->sortBy('name') as $skill)
                                                                <div class="form-check" style="margin-left: 5px;">
                                                                    <input class="form-check-input skill-checkbox"
                                                                        type="checkbox" name="experience[0][skills][]"
                                                                        value="{{ $skill->id }}"
                                                                        id="skill-{{ $skill->id }}"
                                                ...
                                                <button type="button" class="btn mt-7 cancel-experience">
                                ...
                                <button type="button" class="flex items-center gap-2 btn add-experience">
                            ...
                            <div
                                ...
                                <div class="mb-3">
                                    ...
                                    <div id="accordion-skills" data-accordion="collapse"
                                        ...
                                        @foreach ($dev->skills as $index => $skill)
                                                ...
                                                <h2 id="accordion-skills-heading-{{ $index }}">
                                                    <button type="button"
                                                        ...
                                                        <div class="flex items-center gap-2">
                                                            <span class="text-sm  " style="color:#991b1b;">
                                                                @if ($skill->pivot->isontop && $skill->pivot->isprincipal)
                                                                    Top & Principal
                                                                @elseif ($skill->pivot->isontop)
                                                                    Top
                                                                @elseif ($skill->pivot->isprincipal)
                                                                    Principal
                                                                @endif
                                                                </span>
                                                                <span class="text-sm ">({{ $skill->pivot->nbrmonth }} mois)</span>
                                                ...
                                                <div id="accordion-skills-body-{{ $index }}" class="hidden"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="grid grid-cols-2 gap-6 mb-3">
                                                            ...
                                                            <div class="w-full">
                                                                <input type="hidden"
                                                                    name="skills[{{ $skill->id }}][isprincipal]"
                                                                    value="0">
                                                                <input type="checkbox"
                                                                    name="skills[{{ $skill->id }}][isprincipal]"
                                                                    value="1"
                                ...
                                <button type="button" class="flex items-center gap-2 btn add-skill">
                                    <svg class="w-6 h-6 text-blue-600 dark:text-white" aria-hidden="true"
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                        viewBox="0 0 24 24">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div
                                ...
                                <div class="mb-3">
                                    ...
                                    <div id="accordion-education" data-accordion="collapse"
                                        data-active-classes="bg-blue-100 dark:bg-gray-800 text-blue-600 dark:text-white">
                                        @foreach ($dev->educations as $index => $education)
                                                ...
                                                <div id="accordion-education-body-{{ $index }}" class="hidden"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="grid grid-cols-2 gap-6 mb-3">
                                                            ...
                                                            <div class="sm:col-span-2">
                                                                <label for="educations[{{ $index }}][description]" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                                                    Description
                                                                </label>
                                                                <div id="quill-editor-education-{{ $index }}" class="quill-editor-container"></div>
                                                                <input type="hidden" name="educations[{{ $index }}][description]" id="quill-input-education-{{ $index }}" value="{{ $education->description }}" />
                                                            </div>
                                                            ...
                                                            <script>
                                                                document.addEventListener('DOMContentLoaded', function() {
                                                                        ...
                                                                        // Générer l'ID dynamique pour l'éditeur Quill et l'input caché basé sur l'index
                                                                        const editorId = `quill-editor-education-{{ $index }}`;
                                                                        const inputId = `quill-input-education-{{ $index }}`;
                                                                        const quill = new Quill(`#${editorId}`, {
                                                                            theme: 'snow', 
                                                                            modules: {
                                                                                toolbar: [
                                                                        ...
                                                                        // Initialiser Quill avec la valeur actuelle du champ caché (le texte de l'éducation)
                                                                        quill.root.innerHTML = document.getElementById(inputId).value;
                                                            
                                                                        // Synchroniser le contenu de Quill avec le champ caché lors des changements
                                                                        quill.on('text-change', function() {
                                ...
                                <input type="hidden" name="educations_to_delete" id="educations_to_delete"
                                    value="">
                                ...
                                <div class="education-form-container" style="display: none;">
                                    <div class="education-section">
                                        ...
                                        <div
                                            class="rounded-[5px] border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark p-9">
                                            <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Nouvelle
                                                Éducation</h2>
                                            <div class="grid grid-cols-2 gap-6 mb-3">
                                                <div class="w-full">
                                                    <label for="diplome"
                                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Diplôme</label>
                                                    <input type="text"
                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                ...
                                                <div class="w-full">
                                                    <label for="ecole"
                                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">École</label>
                                                    <input type="text"
                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                        name="new_educations[0][école]" placeholder="École">
                                                </div>
                                                <div class="w-full">
                                                    <label for="startdate"
                                                ...
                                                <div class="w-full">
                                                    ...
                                                    <div class="mt-3 form-check">
                                                        <input
                                                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600 ongoing-education"
                                                            type="checkbox" name="education[0][is_current]"
                                                            id="is_current_0" value="1">
                                                        <label
                                                            class="text-sm font-medium text-gray-900 ms-2 dark:text-gray-300"
                                                            for="is_current_0">En cours</label>
                                                    </div>
                                                </div>
                                                <div class="sm:col-span-2">
                                                    <label for="new_educations[0][description]" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Description</label>
                                                    
                                                    <!-- Div pour Quill Editor -->
                                                    <div id="quill-editor-new-education-0" class="quill-editor-container"></div>
                                                    
                                                    <!-- Champ caché pour stocker la valeur de l'éditeur Quill -->
                                                    <input type="hidden" name="new_educations[0][description]" id="quill-input-new-education-0" value="">
                                                </div>
                                ...
                                <button type="button" class="flex items-center gap-2 btn add-education">
                                    <svg class="w-6 h-6 text-blue-600 dark:text-white" aria-hidden="true"
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                        viewBox="0 0 24 24">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="mt-7">
                            <button type="submit"
                                class="!mt-8 px-8 py-2.5 bg-blue-500 text-sm text-white hover:bg-blue-600 rounded-sm">Update
                                Dev</button>
                        </div>
    ...
    <script>
        ...
        function addNewSkill() {
            // Trouver le container modèle à cloner
            var container = document.querySelector('.skill-form-container');

            // Cloner le contenu sans cloner le container lui-même
            var clone = container.cloneNode(true);
            clone.style.display = 'block'; // S'assurer que le clone est visible

            // Ajouter le clone après l'original
            document.querySelector('.skill-form-container').parentNode.insertBefore(clone, container.nextSibling);

            // Réattacher l'événement "cancel" au nouveau bouton cloné
            var cancelButton = clone.querySelector('.cancel-skill');
        ...
        function cancelSkill(event) {
            // Supprimer la section compétence la plus proche du bouton annulé
        ...
        // Écouteur d'événement pour le bouton "Annuler" du formulaire de compétence initial
        document.addEventListener('DOMContentLoaded', function() {
            // Ajouter l'événement au bouton "Annuler" de la première compétence par défaut
            const cancelButton = document.querySelector('.cancel-skill');
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.remove-experience').forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    let experienceSection = document.getElementById('accordion-color-body-' +
                        experienceId);
                    let experienceHeader = document.getElementById('accordion-color-heading-' +
                        experienceId); // Nouvellement ajouté
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            addButton.addEventListener('click', function() {
                ...
                const editorExperience = newExperienceForm.querySelector('.quill-editor-container');
            const hiddenInputExperience = newExperienceForm.querySelector('input[name="new_experience[description]"]');

            const quill = new Quill(editorExperience, {
                theme: 'snow',
                modules: {
                    toolbar: [
                        ['bold', 'italic', 'underline'],
            ...
            quill.on('text-change', function() {
                hiddenInputExperience.value = quill.root.innerHTML;
            });
            });
        });
    </script>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            addEducationButton.addEventListener('click', function() {
                ...
                const editorContainer = newEducationForm.querySelector(`#quill-editor-new-education-0`);
            const hiddenInput = newEducationForm.querySelector(`#quill-input-new-education-0`);
    ...
    <style>
        ...
        /* Réduire la hauteur de l'éditeur Quill */
