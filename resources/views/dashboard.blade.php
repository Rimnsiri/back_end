...
@section('content')
    ...
    <div class="grid w-full grid-cols-1 gap-4 p-20 mt-4 md:grid-cols-2 xl:grid-cols-3">
        <div class="p-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 ">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <span
                        class="text-2xl font-bold leading-none text-gray-900 sm:text-3xl">{{ \App\Models\Dev::count() }}</span>
        ...
        <div class="p-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 ">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <span class="text-2xl font-bold leading-none text-gray-900 sm:text-3xl">2 </span>
        ...
        <div class="p-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 ">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <span class="text-2xl font-bold leading-none text-gray-900 sm:text-3xl">3</span>
    ...
    <div class="rounded-sm  bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1"
>
        ...
        <table class="w-full table-fixed">
            <thead>
                <tr class="bg-gray-100">
                    <th class="w-1/4 px-6 py-4 font-medium text-left text-gray-600 uppercase">id_Dev</th>
                    <th class="w-1/4 px-6 py-4 font-medium text-left text-gray-600 uppercase">nom_dev</th>
                    <th class="w-1/4 px-6 py-4 font-medium text-left text-gray-600 uppercase">nom_Entreprise</th>
                    <th class="w-1/4 px-6 py-4 font-medium text-left text-gray-600 uppercase">Email_Entreprise</th>
                    <th class="w-1/4 px-6 py-4 font-medium text-left text-gray-600 uppercase">téléphone</th>
                    <th class="w-1/4 px-6 py-4 font-medium text-left text-gray-600 uppercase">message</th>
                </tr>
            </thead>
