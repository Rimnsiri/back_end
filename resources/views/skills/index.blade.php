    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="flex justify-center mt-8 space-x-3">
                    <li class="flex items-center justify-center h-8 bg-gray-300 rounded cursor-pointer shrink-0 w-9">
                    ...
                    <li
                        class="flex items-center justify-center shrink-0 cursor-pointer text-sm font-bold text-[#333] w-9 h-8 rounded">
                        1
                    </li>
                    <li
                    ...
                    <li class="flex items-center justify-center h-8 bg-gray-300 rounded cursor-pointer shrink-0 w-9">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-3 rotate-180 fill-gray-500"
