                        ...
                        <form method="POST" action="{{ route('cvs.update', $cv->id) }}" enctype="multipart/form-data">
                            ...
                            @foreach ($cv->experiences as $index => $experience)
                                <div class="experience-section" id="experience_section_{{ $experience->id }}">
                                    ...
                                    <div class="mb-3">
                                        <label for="enddate_{{ $experience->id }}" class="form-label">End Date (optional)</label>
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input ongoing-checkbox" 
                                        ...
                                        <div class="skill-form-group">
                                            ...
                                            <div class="mb-3 form-check">
                                                <input type="hidden" name="skills[{{ $skill->id }}][isprincipal]"
                                                    value="0">
                                                <input type="checkbox" name="skills[{{ $skill->id }}][isprincipal]" value="1" {{ $skill->pivot->isprincipal ? 'checked' : '' }}>
                                                <label class="form-check-label">Compétence principale ?</label>
                                            </div>
                                            <div class="mb-3 form-check">
                                                <input type="hidden" name="skills[{{ $skill->id }}][isontop]"
                                                    value="0">
                                                <input type="checkbox" name="skills[{{ $skill->id }}][isontop]" value="1" {{ $skill->pivot->isontop ? 'checked' : '' }}>
                                                <label class="form-check-label">is ontop?</label>
                                            </div>
                                ...
                                @foreach ($cv->educations as $index => $education)
                                    <div class="education-section" id="education_section_{{ $education->id }}">
                                        ...
                                        <input type="date" class="form-control"
                                            ...
                                            <label for="educations[{{ $index }}][enddate]" class="form-label">End Date (optional)</label>
                                            <input type="date" class="form-control"
                                            ...
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="educations[{{ $index }}][is_current]">En Cours</label>
                                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="french_level" name="french_level">
                                        ...
                                        <option value="C2" {{ $cv->french_level == 'C2' ? 'selected' : '' }}>C2</option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="english_level" name="english_level">
                                        ...
                                        <option value="C2" {{ $cv->english_level == 'C2' ? 'selected' : '' }}>C2</option>
                                    </select>
                                </div>
                            </div>
                            <div class="mt-7">
